            ...
            <?php if (count($customers) > 0): ?>
                <?php foreach ($customers as $customer): ?>
                    <tr>
                        ...
                        <td>
                            <button class="link-button" onclick="location.href='edit_customer.php?id=<?= $customer['customer_id'] ?>'">Редактировать</button>
                            <button class="link-button logout-button" onclick="confirmDelete(<?= $customer['customer_id'] ?>)">Удалить</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
